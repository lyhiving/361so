...
function TypeaheadCtrl($scope, Search, $http, Pdf, DownPdf, Mp3, DownMp3, Film, DownFilm, Zh, DownZh, Tw, DownTw, $timeout){
    ...
    $scope.getLocationFilm = function(val) {
        return $http.get(window.restful.baseURL + 'searchFilm', {
            params: {
                qs: val
            }
        }).then(function(res){
    ...
    $scope.getLocationMp3 = function(val) {
        return $http.get(window.restful.baseURL + 'searchMp3', {
            params: {
                qs:val
            }
        }).then(function(res){
    ...
    $scope.getLocationZh = function(val) {
        return $http.get(window.restful.baseURL + 'search', {
            params: {
                qs:val
            }
        }).then(function(res){
    ...
    $scope.getLocationPdf = function(val) {
        return $http.get(window.restful.baseURL + 'searchPdf', {
            params: {
                qs:val
            }
        }).then(function(res){
